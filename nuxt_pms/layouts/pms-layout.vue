    ...
    <div class="flex min-h-screen bg-gray-50">
        ...
        >
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-3 space-y-0.5 text-sm">
                ...
                <NuxtLink to="/pms/compare" class="sidebar-link" :class="{ active: $route.path.startsWith('/pms/compare') }">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                ...
                <NuxtLink to="/pms/report/tracking" class="sidebar-link" :class="{ active: $route.path.startsWith('/pms/report/tracking') }">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                ...
                <NuxtLink to="/pms/summary" class="sidebar-link" :class="{ active: $route.path.startsWith('/pms/summary') }">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                ...
                <NuxtLink to="/pms/reports" class="sidebar-link" :class="{ active: $route.path.startsWith('/pms/reports') }">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                        <rect x="5" y="2" width="14" height="20" rx="2"/>
